# Adapting Guidelines for Country use - SMART L2 HHAS v0.1.0
...
For information related to standards and interoperability, see the [Dependencies](dependencies.md) page.
