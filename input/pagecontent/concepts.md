...
**Healthcare facility** - Facilities are physical care delivery sites such as hospitals, clinics, health outposts, physician offices, labs, pharmacies, etc. A Facility has a unique identifier, geographic attributes (address, geocode), contact attributes, attributes regarding its hours of operation, etc.[^1].
...
**Health facility registries** - A central authority to uniquely identify all places where health services are administered within a country[^2].

**Health worker registry** - Central authority for maintaining the unique identities of healthcare providers within a country[^2].
